...
class master_barangController extends Controller
{
    public function index(Request $request)
    {
        ...
        /* ========================================================================= */
        /* hasil return dari searchData (hasil hit backend) dimasukkan ke data
    /* ========================================================================= */
        return view(
            'master.form-master-barang',
            // [
            //     'data' => $searchData,
            //     'barang' => $barang
            // ]
    ...
    public function getData(Request $request)
    {
        ...
        return compact('barang', 'currentPage', 'perPage', 'total', 'totalPage', 'hasNextPage', 'hasPrevPage', 'from', 'to');
    }
    ...
    function InsertData(Request $request)
    {
        ...
        $response = Http::withHeaders([
            'Authorization' => $token,
        ])->post($apiUrl . '/api/master-barang', $request->all());
    ...
    public function getDatabyid($id)
    {
        ...
        $response = Http::withHeaders([
            'Authorization' => $token,
        ])->get($apiUrl . '/api/master-barang/' . $id);
    ...
    public function UpdateData(Request $request,  $id)
    {
        ...
        $response = Http::withHeaders([
            'Authorization' => $token,
        ])->patch($apiUrl . '/api/master-barang/' . $id, $request->all());
    ...
    public function DeleteData($id)
    {
        ...
        $response = Http::withHeaders([
            'Authorization' => $token,
        ])->delete($apiUrl . '/api/master-barang/' . $id);
