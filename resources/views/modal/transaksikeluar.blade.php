    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="Modal-title">Transaksi Keluar</h5>
                ...
                <form class="row g-3" id="form-data">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="telepon"
                            placeholder="Masukkan no. telepon pelanggan" required>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-sm">
                                ...
                                <tbody id="tableItemList">
                                    <tr>
                                        <td colspan="10" class="text-center">-- Belum ada item ditambahkan --</td>
                                    </tr>
                                </tbody>
